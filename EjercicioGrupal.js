...
function Pagosaltrabajador(){
    ...
    console.log("sueldo de la jornada :  $" +sueldoJornadanormal)
    console.log ("sueldo de sobre tiempo:  $" +sueldoSobretiempo)
    console.log ( "el ingreso total es " + ingresoTotal)
    console.log("su seguro social es " + seguroSocial)
    console.log(" neto a recibir es " + netoArecibir)
}
...
function elnumeromayordedos(){
    ...
    if ( numero1> numero2){
        console.log( "el mayor de los dos numeros es "+ numero1)
    } else{
        console.log(" el mayor de los numeros es " + numero2)
        }
        } else {
            console.log (" las condiciones no se cumplen el primer numero debe ser par y el segundo debe ser impar")
...
function Letrasosignos(){
    ...
    if (caracter >="a" && caracter<= "z"){
       console.log(" el caracter") + caracter (" es una letra minuscula")
   
    } else if(caracter === ',' || caracter=== '.' || caracter=== ';' || caracter === ':'){
      console.log(" el caracter" + caracter + (" es un signo de puntuacion"))
    }else{
...
function costoColas(){
    ...
    console.log(" su costo total es " + costoFinal)
    }
...
function AlgoritmoX() {
    ...
    if (precioTraje > 200) {
        ...
        precioTraje -= 10
        console.log("Se aplicó un descuento de $10.")
    }
    console.log("El precio final del traje es: $"+ precioTraje)
    }
...
function obtenerNombreDelDia() {
    ...
    if (numeroDeDia >= 1 && numeroDeDia <= 7) {
        console.log("El día " + numeroDeDia + " corresponde a " + diasDeLaSemana[numeroDeDia - 1] + ".")
    } else {
...
function mes() {
    ...
    if (numeroDeMes >= 1 && numeroDeMes <= 12) {
        console.log("El mes " + numeroDeMes + " corresponde a " + mesesDelAño[numeroDeMes - 1] + ".")
    } else {
...
console.log("Último carácter:", direccion[direccion.length - 1])
}
...
function ejercicio16(){
    ...
    nombres.forEach(nombre => {
        console.log(`Nombre: ${nombre}, El primer carácter: ${nombre[0]}, El ultimo carácter: ${nombre[nombre.length - 1]}`);
    });
    ...
    //si (cadena>="0"||cadena<="9") {
        //console.log("El primer caracter es un digito:",cadena.charAt(0))
    //}
    //si no{
        //console.log("El primer caracter no es un digito.")
    //}
    //finsi
    ...
    function ejercicio17(){
        ...
        console.log ("Dada una cadena presentar el primer carácter siempre y cuando sea un digito")
        console.log("La cadena es:",cadena )
        if (caracter>="0"&&caracter<="9") {
            console.log("El primer caracter es un digito:",caracter)
        }
        else{
            console.log("El primer caracter no es un digito.")
        }
    ...
    console.log ("Dada una cadena presentar el ultimo carácter siempre y cuando sea una letra")
    console.log("La cadena es:",cadena )
        if (caracter>="0"&&caracter<="9"||caracter==";"||caracter==":"||caracter=="."||caracter=="," ) {
            console.log("el ultimo caracter no es una letra")
        }
        else{
            console.log("El ultimo caracter es una letra.",caracter)
        }
        }
    ...
    function ejercicio19(){
        ...
        console.log ("Dada una cadena presentar el primer carácter siempre y cuando sea un digito")
        console.log("La cadena es:",letra )
        if (caracter == "A" || caracter == "E" || caracter == "I" || caracter == "O" || caracter == "U"||caracter == "a" || caracter == "e" || caracter == "i" || caracter == "o" || caracter == "u") {
            console.log("El primer caracter es una vocal:",caracter)
        }
        else{
    ...
    function ejercicio20(){
        ...
        console.log ("Dada una cadena presentar el carácter de en medio, siempre y cuando sea un carácter de puntuación: “;” | “:” | “.” | “,”")
        console.log("La cadena es:",puntuación )
        if (caracter==";"||caracter==":"||caracter=="."||caracter=="," ) {
            console.log("El caracter del medio es un caracter de puntunción:",caracter)
        }
        else{
            console.log("El caracter del medio no es caracter de puntunción.")
        }
        }
...
function dosnombres (){
    ...
    if (nombreuno == nombredos){
        ...
        console.log(nombreuno," es menor que ", nombredos)
    } else {
        console.log(nombreuno," es mayor que ", nombredos)
    }
}
...
console.log("La cadena tiene ", numeroelemento, " elementos") 
}
...
function arreglosebas (){
    ...
    console.log("El arreglo tiene ", numeroelemento, " elementos")
}
...
let opciones = {
    ...
    "3": arreglosNumeros,
    "4": librasKgGramos,
    "5": console.log(resolucion(4, 5, 7)),
    "6": Pagosaltrabajador,
...
if (opciones[opcion]) {
    ...
    console.log("El numero de ejercicio no existe")
}
